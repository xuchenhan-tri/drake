...
/* Implements a SAP (compliant) fixed constraint between two points.

 Given two objects A and B with at least one of which being deformable, consider
 a point P on an object A and point Q on an object B. Working in the world frame
 W, this constraint penalizes non-coincident P and Q with the constraint
 function:
