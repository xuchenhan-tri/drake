...
struct SapSolverParameters {
  ...
  enum class SuperNodalSolverType {
    // Super-nodal KKT solver as implemented in conex [Permenter, 2020].
    //
  ...
  SuperNodalSolverType supernodal_solver_type{
      SuperNodalSolverType::kBlockSparse};
};
