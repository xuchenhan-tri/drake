...
class Geometries final : public ShapeReifier {
 public:
  ...
  // TODO(xuchenhan-tri): Determine if these getters are needed.
  /* Returns the representation of the deformable geometry with the given `id`.
   @throws exception if the deformable geometry with the given `id` doesn't
   exist. */
  ...
  /* Returns the representation of the rigid geometry with the given `id`.
   @throws exception if the a rigid geometry with the given `id` doesn't exist.
  */
  ...
  // TODO(xuchenhan-tri): Determine if needed.
  ...
  /* Adds a deformable geometry whose contact mesh representation is given by
   ...
   @pre There is no previous representation associated with id.  */
  void AddDeformableGeometry(GeometryId id, const VolumeMesh<double>& mesh);
