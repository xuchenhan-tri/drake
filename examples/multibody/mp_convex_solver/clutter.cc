...
using drake::multibody::contact_solvers::internal::MpPrimalSolver;
using drake::multibody::contact_solvers::internal::MpPrimalSolverParameters;
using drake::multibody::contact_solvers::internal::MpPrimalSolverStats;
