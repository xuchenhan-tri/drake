 ...
 * MathematicalProgramResult::get_solver_details<ConexSolver>() to obtain the
 * details.
 */
struct ConexSolverDetails {
...
class ConexSolver final : public SolverBase {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(ConexSolver)

  /// Type of details stored in MathematicalProgramResult.
  using Details = ConexSolverDetails;
